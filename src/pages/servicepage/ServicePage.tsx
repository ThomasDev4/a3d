...
const services = [
  {
    id: 1,
    title: "Abeille",
    image_path: "src/assets/images/abeilles.jpg",
    texte: "Résumé de l'article 1",
  },
  {
    id: 2,
    title: "Frelons",
    image_path: "src/assets/images/frelons.jpg",
    texte: "Résumé de l'article 2",
  },
  {
    id: 3,
    title: "Puces",
    image_path: "src/assets/images/puces.jpg",
    texte: "Résumé de l'article 3",
  },
  {
    id: 4,
    title: "Cafard",
    image_path: "src/assets/images/cafards.jpg",
    texte: "Résumé de l'article 4",
  },
  {
    id: 5,
    title: "Souris",
    image_path: "src/assets/images/souris.jpg",
    texte: "Résumé de l'article 5",
  },
  {
    id: 6,
    title: "Rat",
    image_path: "src/assets/images/rats.jpg",
